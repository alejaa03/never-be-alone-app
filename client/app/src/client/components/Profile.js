        ...
        <div className="tab-content tab-space">
              ...
              <div className="col-md-6 mr-auto ml-auto">
                <ul className="list-group main-raised mt-2 p-4">
                  {data.groups.map(elem => {
                      return <li className="list-group-item mb-2 list-group-item-light border-bottom border-dark"> <Link to={`/group/${elem.group.id}`}>{elem.group.name}</Link>  {elem.role === "owner" && <i className="material-icons">star</i>}</li>
                    })
                  }
                </ul>
              </div>
          ...
          <div className="tab-pane gallery" id="events">
            <div className="row just">
              ...
              <ul className="list-group main-raised mt-2 p-4">
                  {events.map(elem => {
                    return <li className="list-group-item mb-2 list-group-item-light border-bottom border-dark"> <Link to={`/event/${elem.id}`}>{elem.name}</Link> </li>
                  })}
                </ul>
              </div>
            </div>
